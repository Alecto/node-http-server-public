...
- ✅ Оновлено navigation з логіном/профілем (`partials/navigation.ejs`)
- ✅ Додано сторінку профілю (`auth/profile.ejs`)
- ✅ Сторінка вимкненої автентифікації (`auth/disabled.ejs`)
- ✅ Безпечне відображення аватарів (`referrerpolicy`, `crossorigin`)
- ✅ Організовано структуру: partials, pages, products, auth, errors
...
│   ├── views/
│   │   ├── partials/          # 🔄 Переиспользуємі компоненти
│   │   │   ├── auth-sidebar.ejs
│   │   │   ├── head.ejs
│   │   │   ├── navigation.ejs  # 🔄 Додано login/profile
│   │   │   └── styles.ejs
│   │   ├── pages/             # Загальні сторінки
│   │   │   └── index.ejs
...
│   │   │   ├── disabled.ejs   # 🆕 Fallback сторінка
